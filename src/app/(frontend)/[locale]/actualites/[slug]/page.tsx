  ...
  return (
    <main className="bg-smatch-black min-h-screen text-smatch-text-primary selection:bg-smatch-gold selection:text-smatch-black pb-32 pt-32">
      ...
      <div className="container grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        {/* SEO: Changed from <main> to <div> to prevent invalid nested <main> tags within the page's outer layout, maintaining valid HTML5 semantics and ensuring proper crawlability. */}
